...
void rpd_funct_multiple(
    ...
    for (long unsigned int i = 0; i < nevol; i++){
        ...
        if (check_reinjection_circular_multiple(fixed_point, xn, xn1, 2, npoints, c) == 1){
...
int main() {
    ...
    f = fopen("../datafiles/test_kimkye_rpd_fixed_points_multiple.dat", "w");
